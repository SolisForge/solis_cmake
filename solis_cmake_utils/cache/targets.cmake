...
function(__get_solis_target_cache_doc _out _type)
    if("${_type}" STREQUAL "CMAKE")
        set(${_out} "CMake files to install and load when importing the package")
    elseif ("${_type}" STREQUAL "CMAKE_NOLOAD")
        set(${_out} "CMake files to install by not to load when importing the package")
    elseif ("${_type}" STREQUAL "CMAKE_MODULE")
        set(${_out} "CMake module to install and load when importing the package")
